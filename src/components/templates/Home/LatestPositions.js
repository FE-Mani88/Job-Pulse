...
export default function LatestPositions() {
    return (
        <div className="max-w-6xl mx-auto text-zinc-700 mt-10">
                ...
                <SwiperSlide className="w-48 h-full bg-[#f6f6f8] flex items-center justify-center rounded-lg text-white text-2xl">
                    <div className="p-3">
                        ...
                        <div className="mt-2 flex flex-col gap-2">
                            <p className="text-[18px] text-zinc-700 w-[98%] mx-auto">we need a senior full stack web developer in our startup. you can send your resume for joining to our company.</p>
